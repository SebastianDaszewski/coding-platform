    ...
    <>
      {!formSubmitted ? (
        <div className="relative flex justify-center h-full">
          <SnackbarProvider />
          <div className="top-5 tall:top-100 w-175 h-150 p-9 rounded-lg gap-32 text-white flex flex-col justify-start items-center relative shadow-custom bg-customGray shortMax:top-0 shortMax:scale-90">
            <form className="w-159" onSubmit={handleSubmit(onSubmit)}>
              ...
              <button
                type="submit"
                className="mt-2 mb-2 text-base/6 font-medium h-10 w-159 py-2.5 px-5 text-white bg-blue hover:bg-blue focus:ring-4 focus:outline-none focus:ring-blue rounded-lg text-center"
              >
                {t("registration")}
              </button>
              <TextLink
